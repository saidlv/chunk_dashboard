...
class ImageHotspotMatchText extends StatefulWidget {
  const ImageHotspotMatchText({ Key? key }) : super(key: key);

  @override
  _ImageHotspotMatchTextState createState() => _ImageHotspotMatchTextState();
}

class _ImageHotspotMatchTextState extends State<ImageHotspotMatchText> {
 ...
 @override
  ...
  Widget build(BuildContext context) {
    ...
    children: [  Text('Task Description:',style:TextStyle(color: theme.darkTextColor,fontSize: 11.5) ,),
      SizedBox(height: 3,),
      ...
      Row(mainAxisAlignment: MainAxisAlignment.center,
        children: [SizedBox(width: 50,),
          Container(alignment: Alignment.centerLeft,width:MediaQuery.of(context).size.width/4,
                                  padding: EdgeInsets.symmetric(horizontal: 10,vertical: 10),margin: EdgeInsets.only(bottom: 10)
                                ,decoration: BoxDecoration(borderRadius: BorderRadius.circular(5),
                                    color: theme.whiteColor
  ...
  Widget imageBox(){
    return Padding(
      ...
      child: Column(
        ...
        children: [
           Text('Add "hotspots" based on the area numbers above:',style:TextStyle(color: theme.darkTextColor,fontSize: 11.5) ,),
        SizedBox(height: 3,),
        Container(alignment: Alignment.centerLeft
                              ,decoration: BoxDecoration(borderRadius: BorderRadius.circular(5),
                    ...
                    element['selected']=false;
                                                ...
                                                child: Container(margin: EdgeInsets.only(left: 10),
                                                  ...
                                                  child:  Text(areasList[i]['bodyPart'],style: TextStyle(color: theme.darkTextColor,fontSize: 10.5,fontWeight: FontWeight.w500,
                                                                        decoration: TextDecoration.none
                                                                        ),)
                                                ),
                                              )
                                    ...
                                    Center(
                                      child: Container(height: 180,width:180,color: theme.lightTextColor.withOpacity(.6),
                                      child: Center(child: Image.asset('assets/animal_image.png',)),
                                      ),
                                    ),SizedBox(height: 10,)
                                  ],
                                )
      ...
      Align(alignment: Alignment.center,
        child: GestureDetector(onTap: () {
                                        ...
                                        child: Text(
                                          '+ add Hotspot',style: TextStyle(color: theme.mainColor,fontSize: 12,fontWeight: FontWeight.w400,
                                          decoration: TextDecoration.none
                                          ),
                                                ),
                                      ),
