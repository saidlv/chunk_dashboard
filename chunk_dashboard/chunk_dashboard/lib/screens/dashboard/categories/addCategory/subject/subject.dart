      ...
      children: [
        ...
        Padding(
                      ...
                      child: Row(
                        ...
                        SizedBox(width: 20,),Container(alignment: Alignment.center,
                            padding: EdgeInsets.symmetric(horizontal: 10),height: 30,
                                  ...
                                  ),child:  Text('Upload Image',style: TextStyle(color: theme.whiteColor,fontSize: 11,fontWeight: FontWeight.w400,
                            decoration: TextDecoration.none
                            ),
                                  ),
                    ...
                    Container(alignment: Alignment.center,
                            ...
                            Text('Recently Added Subject in this Path:',style: TextStyle(color: theme.mainColor,fontSize: 13,fontWeight: FontWeight.w500,
                          decoration: TextDecoration.none
                          )),SizedBox(height: 20,),
                         Padding(
                      ...
                      children: [SizedBox(width:210,child:Row(children: [Container(
                       ...
                       decoration: BoxDecoration(color: theme.darkTextColor,shape: BoxShape.circle),
                        ...
                        Text('Integral Analysis for beginners',style: TextStyle(color: theme.darkTextColor,fontSize: 12,fontWeight: FontWeight.w500,
                                          decoration: TextDecoration.none
                                          ),
                                          )],) ,),SizedBox(width: 10,),
                      ...
                      children: [SizedBox(width:210,child:Row(children: [Container(
                       ...
                       decoration: BoxDecoration(color: theme.darkTextColor,shape: BoxShape.circle),
                        ...
                        Text('Fraction Analysis for intermediate',style: TextStyle(color: theme.darkTextColor,fontSize: 12,fontWeight: FontWeight.w500,
                                          decoration: TextDecoration.none
                                          ),
                                          )],) ,),SizedBox(width: 10,),
                        Text('edit',style: TextStyle(color: theme.darkTextColor,fontSize: 11,fontWeight: FontWeight.w500,
